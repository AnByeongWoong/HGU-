...
export default class RestaurantList extends Component {
  ...
  sortDataToList(){
    ...
    ////// 지역 종류 선택 or 배달까지 상관 없
    // else if(tagArray.key_num != 83 && tagArray.region_count_bool ==true && this.state.data[i].delivery == String(tagArray.delivery_bool) ){
      ...
      for(var k=0; k<6; k++){
        ...
        /////////체크  여기 꼭 다시 확인하기
          if(tagArray.key_num % this.state.data[i].kind == 0 && this.state.data[i].region == tagArray.region_name[k] && this.state.data[i].delivery == String(tagArray.delivery_bool) ){
